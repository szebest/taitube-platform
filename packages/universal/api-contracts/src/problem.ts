...
const PROBLEM_STATUS: Readonly<Record<ErrorCode, number>> = {
  ...
  [ErrorCodes.PLAYLIST_NOT_FOUND]: 404,
  [ErrorCodes.PLAYLIST_ITEM_NOT_FOUND]: 404,
  ...
  [ErrorCodes.COMMENT_NOT_PINNABLE]: 409,
  ...
  [ErrorCodes.FORMAT_UNSUPPORTED_LOCALE]: 422,
  [ErrorCodes.FORMAT_UNKNOWN_OPTION]: 422,
  [ErrorCodes.FORMAT_WRONG_KIND]: 422,
  [ErrorCodes.FORMAT_UNRENDERABLE]: 422,
