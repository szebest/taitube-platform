...
import { validateAndParseProbe } from '../probe-metadata';
import { PROBE_LIMITS } from './encoder-settings';

type RawFfprobeOutput = Parameters<typeof validateAndParseProbe>[0];
type RawStream = NonNullable<RawFfprobeOutput['streams']>[number];
...
describe('@vp/ffmpeg: validateAndParseProbe', () => {
