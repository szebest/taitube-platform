...
- The streaming segment uploader (`apps/worker/src/stages/segment-uploader.ts`) uploads segments to S3/R2 as they finish encoding and removes them immediately, keeping local disk usage strictly bounded to `sourceSize + 3 * maxSegmentBytes`.
