...
- [x] `SubscriptionRepositoryPort` in `@taitube/core/repositories/subscription-repository.port.ts`.
...
- [x] Redis subscription set caching service (`adapters/redis/subscription-cache.service.ts`).
